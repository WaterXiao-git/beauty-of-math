...
<div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4">
              ...
              <p className="text-sm text-slate-600 mb-2">质因子：{factors.length ? factors.join(', ') : '无（n=1）'}</p>
              <p className="text-sm text-slate-600 leading-relaxed">互质数：{coprimes.slice(0, 30).join(', ')}{coprimes.length > 30 ? ' …' : ''}</p>
            </div>
