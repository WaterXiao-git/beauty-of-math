...
- 课程首页已按客户示意改为默认三栏知识工作区：桌面端常驻“章节树—知识地图与同小节卡片—当前知识点详情”，章节树可一键收起；移动端自动切换为可搜索抽屉。
...
| 路由 | 用途 |
| --- | --- |
| `/` | 客户版课程主页面，默认展示“函数的极限”三栏知识工作区 |
| `/?point=:pointId` | 切换知识点，并联动章节树、知识地图、同小节卡片和右侧详情 |
| `/experiments` | 独立的 300 个正式实验浏览、搜索与难度筛选页 |
| `/ask` | AI 智能提问与五分支路由结果 |
