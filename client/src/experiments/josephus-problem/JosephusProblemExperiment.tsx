          ...
          <>
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4">
              ...
              <div className="flex gap-2 mt-4">
                ...
                <button onClick={() => { setStep(0); setPlaying(false) }} className="px-3 py-2 rounded-lg text-sm font-medium bg-gray-100 text-slate-700 hover:bg-gray-200">
                  ↺ 重置
                </button>
              </div>
