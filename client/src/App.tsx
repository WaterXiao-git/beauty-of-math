...
const DynamicExperimentPage = lazyRetry(() => import('./dynamic-experiment/DynamicExperimentPage'))
const BugAdminPage = lazyRetry(() => import('./pages/BugAdminPage'))
const RetiredContentPage = lazyRetry(() => import('./pages/RetiredContentPage'))
        ...
        <Suspense fallback={<Loading />}>
          <Routes>
            <Route path="/" element={<Layout />}>
              ...
              <Route path={APP_ROUTE_PATHS.temp} element={<TempExperiment />} />
              <Route path={APP_ROUTE_PATHS.generatedExperiment} element={<DynamicExperimentPage />} />
